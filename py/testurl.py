...
def test_url(URL):
    ...
    website_file = open("/home/lxw/lxw.html", mode="wb")
    ...
    print("{}的平均下载速度: {}".format(URL, website.getinfo(pycurl.SPEED_UPLOAD)))
    print("{}的平均上传速度: {}".format(URL, website.getinfo(pycurl.SPEED_DOWNLOAD)))
    print("{}的HTTP头部大小: {}".format(URL, website.getinfo(pycurl.HEADER_SIZE)))
    website_file.close()
    website.close()


test_url("http://www.lxw.com")
